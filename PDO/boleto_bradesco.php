...
$taxa_boleto = 2.95;
$data_venc = date("22/11/2019", time() + ($dias_de_prazo_para_pagamento * 86400));  // Prazo de X dias OU informe data: "13/04/2006";
$valor_cobrado = "15,00"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$dadosboleto["endereco1"] = "Endereçoo do seu Cliente";
...
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: cscomp@esports.com.br";
...
// SEUS DADOS
$dadosboleto["identificacao"] = "CS COMP - Campeonatos E-esports";
$dadosboleto["cpf_cnpj"] = "";
$dadosboleto["endereco"] = "rua qualquer, número 93";
$dadosboleto["cidade_uf"] = "Campinas - SP";
$dadosboleto["cedente"] = "CS COMP";
