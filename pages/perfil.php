...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <form method="POST" action="../PDO/alteraBD.php">
        <div class="card">      
            <div class="card-body">
              <h4 class="card-title">Painel de edição</h4>
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">CPF</label>
                <input type="text" name="cpf" class="form-control" id="cpf" value="<?php echo $_SESSION['user_cpf']?>">
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">CELULAR</label>
                <input type="text" name="cel" class="form-control" id="cel" value="<?php echo $_SESSION['user_cel']?>">
            </div>
                  
            <button type="submit" class="btn btn-success mr-2"><?php echo "<a  href='../PDO/alteraBD.php?id=".$_SESSION['user_id']."'>Alterar conta</a>" ?></button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button class="btn btn-light"><?php echo "<a  href='../PDO/excluiBD.php?id=".$_SESSION['user_id']."'>Sim, tenho certeza;</a>" ?></button>
