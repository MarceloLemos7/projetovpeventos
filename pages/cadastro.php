...
<form method="POST"action="../PDO/cadastroBD.php"> 
        <div class="card">
                <div class="card-body">
                  <h4 class="card-title">FORMULARIO DE CADASTRO JOGADOR SOLO</h4>
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      <label for="exampleInputCity1">CPF</label>
                      <input type="cpf" name="cpf" class="form-control" id="exampleInputCity1" placeholder="CPF DO PARTICIPANTE">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputCity1">CELULAR</label>
                      <input type="celular" name="cel" class="form-control" id="exampleInputCity1" placeholder="CELULAR DO PARTICIPANTE">
                    </div>
